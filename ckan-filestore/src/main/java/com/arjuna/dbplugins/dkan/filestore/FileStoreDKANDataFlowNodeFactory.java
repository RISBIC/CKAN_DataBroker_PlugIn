...
public class FileStoreDKANDataFlowNodeFactory implements DataFlowNodeFactory
{
    public FileStoreDKANDataFlowNodeFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidNameException, InvalidMetaPropertyException, MissingMetaPropertyException, InvalidPropertyException, MissingPropertyException
    {
        ...
        {
            if (metaProperties.isEmpty())
                return (T) new FileStoreDKANDataService(name, properties);
            else
